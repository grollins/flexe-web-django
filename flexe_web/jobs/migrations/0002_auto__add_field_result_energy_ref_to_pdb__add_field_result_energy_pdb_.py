...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.energy_ref_to_pdb'
        db.add_column(u'jobs_result', 'energy_ref_to_pdb',
                      self.gf('django.db.models.fields.FloatField')(default=-99.9),
                      keep_default=False)

        # Adding field 'Result.energy_pdb_to_ref'
        db.add_column(u'jobs_result', 'energy_pdb_to_ref',
                      self.gf('django.db.models.fields.FloatField')(default=-99.9),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.energy_ref_to_pdb'
        db.delete_column(u'jobs_result', 'energy_ref_to_pdb')

        # Deleting field 'Result.energy_pdb_to_ref'
        db.delete_column(u'jobs_result', 'energy_pdb_to_ref')
